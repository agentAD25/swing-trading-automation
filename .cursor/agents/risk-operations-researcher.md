...
Follow `docs/research/README.md`. Treat `SIM` as the sole authorized mode and
`LIVE` as prohibited. Escalate any design that could fail open, use real
credentials, touch a real account, or risk real capital. Return evidence and
unresolved decisions to the governance coordinator; do not make architecture
decisions.
